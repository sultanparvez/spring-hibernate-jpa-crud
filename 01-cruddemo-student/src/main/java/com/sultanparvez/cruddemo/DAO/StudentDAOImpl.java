...
//        TypedQuery <Student> theQuery = entityManger.createQuery("FROM Student order by lastName", Student.class);
    ...
    public void delete(Integer id) {
       Student tempStudent = entityManger.find(Student.class, id);
       entityManger.remove(tempStudent);
    }
...
//        System.out.println("Here");
        int numRowsDeleted = entityManger.createQuery("DELETE FROM Student").executeUpdate();
